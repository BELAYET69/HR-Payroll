						...
						<li>
							<div class="cart dropdown">
					  			...
					  			<div class="dropdown-menu dropup">
						  			...
						  			<ul class="media-list">
								  		<li class="media">
										    <img class="pull-left" src="{{asset('fontend/images/product-item.jpg')}}" alt="">
			...
			<div class="row">
				<div class="col-md-12">
					<div id="slider" class="nivoSlider">
				    	<img src="{{asset('fontend/images/slider.jpg')}}" alt="" />
				    	<img src="{{asset('fontend/images/slider1.jpg')}}" alt=""/>
				    	<img src="{{asset('fontend/images/slider2.jpg')}}" alt="" />
					...
					<div class="block">
						...
						<div class="row">
						  	<div class="col-sm-6 col-md-4">
							    <div class="thumbnail">
							    	<a class="catagotie-head" href="blog-single.html">
										<img src="{{asset('fontend/images/category-image-1.jpg')}}" alt="...">
										<h3>Beef Steak</h3>
									</a>
							      	<div class="caption">
						  	...
						  	<div class="col-sm-6 col-md-4">
							    <div class="thumbnail">
							    	<a class="catagotie-head" href="blog-single.html">
										<img src="{{asset('fontend/images/category-image-2.jpg')}}" alt="...">
										<h3>Miscellaneous</h3>
									</a>
							      	<div class="caption">
							        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste, aut, esse, laborum placeat id illo a expedita aperiam...</p>
						  	...
						  	<div class="col-sm-6 col-md-4">
							    <div class="thumbnail">
							    	<a class="catagotie-head" href="blog-single.html">
										<img src="{{asset('fontend/images/category-image-3.jpg')}}" alt="...">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="products">
						<a href="single-product.html">
							<img src="{{asset('fontend/images/product-image.jpg')}}" alt="">
						</a>
						<a href="single-product.html">
				...
				<div class="col-md-3">
					<div class="products">
						<a href="single-product.html">
							<img src="{{asset('fontend/images/product-image-2.jpg')}}" alt="">
						</a>
						<a href="single-product.html">
							<h4>Amazing Italian Sauces</h4>
						</a>
				...
				<div class="col-md-3">
					<div class="products">
						<a href="single-product.html">
							<img src="{{asset('fontend/images/product-image-3.jpg')}}" alt="">
						</a>
						<a href="single-product.html">
							<h4>Amazing Italian Sauces</h4>
						</a>
				...
				<div class="col-md-3">
					<div class="products">
						<a href="single-product.html">
							<img src="{{asset('fontend/images/product-image-5.jpg')}}" alt="">
						</a>
						<a href="single-product.html">
							<h4>Amazing Italian Sauces</h4>
						</a>
				...
				<div class="col-md-3">
					<div class="products">
						<a href="single-product.html">
							<img src="{{asset('fontend/images/product-image-6.jpg')}}" alt="">
						</a>
						<a href="single-product.html">
							<h4>Amazing Italian Sauces</h4>
						</a>
				...
				<div class="col-md-3">
					<div class="products">
						<a href="single-product.html">
							<img src="{{asset('fontend/images/product-image-7.jpg')}}" alt="">
						</a>
						<a href="single-product.html">
							<h4>Amazing Italian Sauces</h4>
						</a>
				...
				<div class="col-md-3">
					<div class="products">
						<a href="single-product.html">
							<img src="{{asset('fontend/images/product-image-8.jpg')}}" alt="">
						</a>
						<a href="single-product.html">
							<h4>Amazing Italian Sauces</h4>
						</a>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div id="owl-example" class="owl-carousel">
						<div> <img src="{{('fontend/images/company-1.png')}}" alt=""></div>
						<div> <img src="{{('fontend/images/company-2.png')}}" alt=""></div>
						<div> <img src="{{('fontend/images/company-3.png')}}" alt=""></div>
						<div> <img src="{{('fontend/images/company-4.png')}}" alt=""></div>
						<div> <img src="{{('fontend/images/company-5.png')}}" alt=""></div>
						<div> <img src="{{('fontend/images/company-6.png')}}" alt=""></div>
						<div> <img src="{{('fontend/images/company-8.png')}}" alt=""></div>
						<div> <img src="{{('fontend/images/company-9.png')}}" alt=""></div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="block clearfix">
						<a href="#">
							<img src="{{asset('fontend/images/footer-logo.png')}}" alt="">
						</a>
						<p>
					...
					<div class="block">
						...
						<div class="media">
						  	<a class="pull-left" href="#">
						    	<img class="media-object" src="{{asset('fontend/images/product-item.jpg')}}" alt="...">
						  	</a>
						  	<a class="pull-left" href="#">
						    	<img class="media-object" src="{{asset('fontend/images/product-item.jpg')}}" alt="...">
						  	</a>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="cash-out pull-left">
							<li>
								<a href="#">
									<img src="{{asset('fontend/images/American-Express.png')}}" alt="">	
								</a>
							</li>
							<li>
								<a href="#">
									<img src="{{asset('fontend/images/PayPal.png')}}" alt="">	
								</a>
							</li>
							<li>
								<a href="#">
									<img src="{{asset('fontend/images/Maestro.png')}}" alt="">	
								</a>
							</li>
							<li>
								<a href="#">
									<img src="{{asset('fontend/images/Visa.png')}}" alt="">	
								</a>
							</li>
							<li>
								<a href="#">
								 	<img src="{{asset('fontend/images/Visa-Electron.png')}}" alt="">  	
								</a>
							</li>
						</ul>
